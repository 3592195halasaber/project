  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row justify-between mx-8 my-10 ">
        <span className=" text-xl mb-2 sm:mb-0 text-blue-500 ">
        ...
        <button  className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"> <Link to={'/ShippingAddress'}>Check Out</Link></button>
      </div>
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div className="flex justify-center items-center mt-4">
          <button
            onClick={clearCart}
            className="btn bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full m-10"
          >
            Clear Cart
          </button>
        </div>
