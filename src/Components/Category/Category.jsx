...
export default function Category() {
  ...
  return (
    <div className="container mx-auto pt-10">
      <h2 className="text-4xl text-center text-blue-600 mb-10">Categories</h2>
        ...
        {categories.map((category) => (
          ...
          >
            <img
              ...
              alt={category.name}
            />
            <h3 className="text-2xl text-blue-500 text-center p-5">
              {category.name}
            </h3>
          </div>
        ))}
      ...
      {loadingSubCategory && (
        <p className="text-center text-lg text-blue-500">Loading Subcategories...</p>
      )}

      {activeCategory && subCategories[activeCategory]?.length > 0 && (
        <div className="mt-10 p-10">
          <h2 className="text-3xl text-blue-600 mb-5">Subcategories</h2>
          <div className="grid grid-cols-12 gap-5">
            {subCategories[activeCategory].map((sub) => (
              ...
              >
                <h4 className="text-lg text-blue-700 text-center">
                  {sub.name}
                </h4>
              </div>
            ))}
