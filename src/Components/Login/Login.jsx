...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className='my-10'>
        <h2 className=' text-3xl mb-5 text-blue-500 font-bold'>Login Form</h2>
        <form onSubmit={formik.handleSubmit} className="mx-auto">
          ...
          <div className="mb-5">
            ...
            <input name='email' onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.email} type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com" required />
