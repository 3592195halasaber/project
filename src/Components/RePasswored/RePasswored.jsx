...
export default function RePasswored() {
    ...
    return (<>
        <div className='my-10 p-10'>
            <h2 className=' text-3xl mb-5 text-blue-500 font-bold ' >Reset your account password </h2>
            <form onSubmit={formik.handleSubmit} className="mx-auto"  >
                ...
                <div className="mb-5 ">
                    <input type="code" name="resetCode" id="resetCode" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.resetCode} required />
                ...
                <button type="submit" className="btn-blue" disabled={loding}> {loding ? "Loading..." : "Verify"}
                </button>
            </form>
