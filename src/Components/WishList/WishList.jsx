...
export default function WishList() {
  ...
  return (
    <div className="container">
      <h2 className="text-blue-600 text-3xl ms-24 mt-10">My Wish List</h2>
        ...
        <tbody>
          ...
          {wishlist?.data?.map((item) => (
            ...
            >
              ...
              <button onClick={() => AddProudect(item._id)} className='border-blue-500 border-2 m-auto px-5 mb-5  inline-flex  mt-auto items-center  py-2 text-sm font-medium text-center text-black rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800' >
                +Add
              </button>
              </td>
